...
|---|---|
| M0 Design | `APPROVED` |
| M1 Evidence Prototype | `IN PROGRESS — P0-P5 PASS` |
...
M1-P0, P1, P2, P3, P4 và P5 đã hoàn tất PASS: P0/P1 qua remediation audit R1, P2 Temporal G01 proof đạt 7/7 test, P3 Google Drive & OAuth G04 proof đạt 8/8 test (bao gồm kiểm thử Live E3 probe trên Google Drive thật), P4 Local Journal & Recovery proof đạt 6/6 test, P5 Compatibility Smoke đạt 6/6 test. Tổng test suite hiện có 69 test qua; coverage đạt 89%. Cả G01 và G04 đều đạt `PARTIALLY_PROVEN (PASS_M1_SCOPE)`; work package kế tiếp là M1-P6 (Evidence synthesis & Audit).
...
M1-P0, P1, P2, P3, P4 và P5 đã hoàn tất `PASS`; G01 và G04 đều đạt `PARTIALLY_PROVEN (PASS_M1_SCOPE)` với evidence đầy đủ tại `docs/milestones/m1-proof/evidence/m1-p2/`, `evidence/m1-p3/`, `evidence/m1-p4/` và `evidence/m1-p5/`. Work package tiếp theo là M1-P6 (Evidence synthesis & Audit); M2/M3/Module A vẫn `NOT AUTHORIZED`.
