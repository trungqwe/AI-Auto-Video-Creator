...
> Cập nhật hiện hành: M2-P1..P5B là `ACCEPTED / CLOSED`; M2-P6 chỉ được phép tạo Behavioral RED. Implementation P6, P7+, M3 và Phân hệ A vẫn `NOT AUTHORIZED`.
...
| M2 Control Plane | `M2-P1..P5B_ACCEPTED_CLOSED; M2-P6_BEHAVIORAL_RED_AUTHORIZED` |
