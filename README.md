...
> Cập nhật hiện hành: M2-P2 là `ACCEPTED / CLOSED`; M2-P3 ở `M2-P3_BEHAVIORAL_RED_BLOCKED_EXTERNAL` vì thiếu runtime `psycopg_pool==3.3.1`. Structural RED harness tồn tại nhưng chưa được collect/full RED; M2-P4..P7, M3 và Module A vẫn `NOT AUTHORIZED`.
...
| M2 Control Plane | `M2-P1_ACCEPTED_CLOSED; M2-P2_ACCEPTED_CLOSED; M2-P3_BEHAVIORAL_RED_BLOCKED_EXTERNAL` |
