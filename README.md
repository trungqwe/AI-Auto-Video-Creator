...
> Cập nhật hiện hành: M2-P1..P5B là `ACCEPTED / CLOSED`; architecture-wired M2-P6 Behavioral RED (`run-m2-p6-20260916190000`) đã được chấp thuận và implementation P6 đã được ủy quyền. P7+, M3 và Phân hệ A vẫn `NOT AUTHORIZED`.
...
| M2 Control Plane | `M2-P1..P5B_ACCEPTED_CLOSED; M2-P6_BEHAVIORAL_RED_ACCEPTED; M2-P6_IMPLEMENTATION_AUTHORIZED` |
