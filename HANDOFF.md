...
- Đã quyết định: M1, M2-P0 và M2-P1 là `ACCEPTED / CLOSED`. M2-P2 là `M2-P2_PLAN_READY_FOR_RED_APPROVAL`: scope contracts, schema `0002`, RFC 8785 JCS, replay receipt, PostgreSQL CAS, exact 11 oracle, sáu gates và evidence protocol đã khóa.
