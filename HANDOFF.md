...
- Trạng thái: `M2-P2_BEHAVIORAL_RED_BLOCKED_EXTERNAL`. Run prerequisite `run-m2-p2-20260914130238` xác nhận Python/driver lock nhưng `M2_TEST_PG_DSN` absent và Docker daemon unavailable; P2-003..011 cùng PostgreSQL/CREATEDB/orphan chưa chạy. P2-001/002 có RED hợp lệ historical tại run `120642`.
- Evidence: `docs/milestones/m2-control-plane/evidence/m2-p2/red-p2-runtime-run-m2-p2-20260914130238-prerequisite-stdout.txt`, `red-observations.md`; raw run `120642`, `122615`, `123753` và toàn bộ run trước giữ historical immutable.
