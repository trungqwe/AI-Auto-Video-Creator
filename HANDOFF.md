...
- Trạng thái: `M2-P2_RED_HARNESS_FINAL_READY_BLOCKED_EXTERNAL`. Run `run-m2-p2-20260914115450` collect exact 11 behavioral oracle nhưng `M2_TEST_PG_DSN=UNSET`; PostgreSQL/CREATEDB/orphan chưa kiểm tra, full run không khởi động và 0 oracle được tính Behavioral RED.
- Evidence: `docs/milestones/m2-control-plane/evidence/m2-p2/red-p2-runtime-run-m2-p2-20260914115450-collect-stdout.txt`, `red-p2-runtime-run-m2-p2-20260914115450-prerequisite-stdout.txt`, `red-observations.md`. Các run trước giữ historical immutable.
