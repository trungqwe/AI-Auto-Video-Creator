...
**Điểm dừng bắt buộc:** P1..P5B là `ACCEPTED / CLOSED`. Exact four P6 Behavioral RED đã sẵn sàng independent review; implementation P6, P7+, M3 và Phân hệ A vẫn `NOT AUTHORIZED`.
**Căn cứ kiến trúc:**
