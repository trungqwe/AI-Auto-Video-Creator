...
**Điểm dừng bắt buộc:** P1..P7A là `ACCEPTED / CLOSED`. Independent review chấp thuận source/tooling P7A `6c3a52bde905ee5e71e12334da1873ed20f5c5db` và GREEN `run-m2-p7a-green-20260916224033`; accepted RED và rejected historical GREEN giữ nguyên. Checkpoint `763aa63b` chấp nhận P7B authority; Behavioral RED `run-m2-p7b-red-20260917000606` đã witnessed và đang chờ independent review, chưa được ACCEPTED. Future fence/sequence allocation/INSERT phải nằm trong **một SQL statement** tương thích cả autocommit và P1 UoW. P7B implementation vẫn khóa; không sửa P3 hay migration `0008`. P8/P9 khóa; M3 và Phân hệ A `NOT AUTHORIZED`.
**Căn cứ kiến trúc:**
