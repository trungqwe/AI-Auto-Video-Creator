...
- Run ID: `run-m2-p4-20260915000809`.
...
- Collection: exact 9 identities. Full execution: 9 failed, 0 errors, 0 skips. Every failure reached the P4 structural seam and observed `NotImplementedError`; no import, syntax, fixture, or collection failure occurred.
...
- `red-p4-run-m2-p4-20260915000809-prerequisite-stdout.txt`
- `red-p4-run-m2-p4-20260915000809-collect-stdout.txt`
- `red-p4-run-m2-p4-20260915000809-stdout.txt`
- `red-p4-run-m2-p4-20260915000809-architecture-stdout.txt`
- `red-p4-run-m2-p4-20260915000809-secret-scan-stdout.txt`
