...
| M2 | 🟡 `M2-P5A_PLAN_READY_FOR_REVIEW; M2-P5B_PLAN_READY_FOR_REVIEW` | P1..P4 `ACCEPTED / CLOSED`. P5A/P5B chỉ được planning/contract traceability; chưa RED/implementation. P5B migration RED/implementation chờ P5A/`0004` accepted; P6..P7 vẫn khóa. |
