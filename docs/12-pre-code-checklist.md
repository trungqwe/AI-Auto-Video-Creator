...
| M2 | 🟡 `M2-P1..P7A_ACCEPTED_CLOSED; M2-P7B_AUTHORITY_ACCEPTED; M2-P7B_BEHAVIORAL_RED_ACCEPTED; M2-P7B_IMPLEMENTATION_AUTHORIZED; M2-P7B_INDEX_AUTHORITY_DELTA_ACCEPTED; M2-P7B_BLOCKED_P7A_TRACKER_ORACLE` | P7A accepted oracle SHA-256 `63151da21b07c3dd92c5b4a7acc0d4f952f188ee2425a52c9d3ac8d34eb61035` bất biến. Independent review chấp nhận P7B RED source/test `c35571fb334dc7b842ee23378f041e74f1caa277`, oracle SHA-256 `d83d0f2d808f1b0067d5288ea131ded24d8fc46a16462b5254fd4167f7425738` và evidence `run-m2-p7b-red-20260917002633`; run RED cũ bất biến. Review checkpoint `aed557f5269f0af7641197d9b662b2dcff5e8d65` cho phép đúng migration `0008` tạo index `(workspace_id, stream_event_id)`, không sửa `0001..0007`/`MigrationRunner` hoặc tạo `0009`. Gate migration/H18 targeted và P7B oracle 5/5 đạt nhưng chưa final evidence. P7A hardening chỉ 35/36 vì accepted `test_h16_migration_tracker` đòi `[1..7]` trong khi schema mới có `[1..8]`; STOP xin independent review, không tự sửa oracle. P7B chưa GREEN/accepted/closed; P8/P9 khóa; M3/Phân hệ A `NOT AUTHORIZED`. |
