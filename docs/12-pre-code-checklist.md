...
**Ngày lập:** 12-09-2026 (Cập nhật sau Audit R5: 13-09-2026)  
**Trạng thái:** M0 APPROVED/CLOSED; M1 HOÀN TẤT KHẮC PHỤC KIỂM TOÁN ĐỘC LẬP R5 (P0-P6 PASS, 91 passed, 0 skipped, coverage 85%), Audit R5 hoàn tất -> Sẵn sàng cho User Checkpoint duyệt M1  
**Cổng áp dụng:** M0 → M1 của [roadmap](./11-roadmap.md)  
**Căn cứ audit hiện hành:** [M1 audit R5](./milestones/m1-proof/audit-r5.md), [M1 audit R4](./milestones/m1-proof/audit-r4.md), [M1 audit R3](./milestones/m1-proof/audit-r3.md), [M1 audit R2](./milestones/m1-proof/audit-r2.md) và [M1 audit R1](./milestones/m1-proof/audit-r1.md)
...
- Phê duyệt baseline và quyền code M1 đã được ghi nhận ngày 13-09-2026. Quyền đó đã được kích hoạt cho M1; P0-P6 đã hoàn tất và vượt qua Audit R5, nhưng không mở quyền cho M2/M3/Phân hệ A.
...
| M1 | 🟢 `READY_FOR_USER_CHECKPOINT` | Toàn bộ P0-P6 đã PASS; 91 passed, 0 skipped; Audit R5 đạt; sẵn sàng trình User |
| G01 Temporal | 🟡 `PARTIALLY_PROVEN (PASS_M1_SCOPE)` | P2 đã PASS trên exact official binary `temporal-server.exe` v1.31.2 port 7233 |
| G04 Drive/OAuth | 🟡 `PARTIALLY_PROVEN (PASS_M1_SCOPE)` | P3 đã PASS E3 (ADR-0009 Subprocess Broker OS isolation, Windows DPAPI Vault, live E3 probe xác thực Drive thật) |
