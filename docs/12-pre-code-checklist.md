...
| M2 | 🟡 `M2-P1..P7A_ACCEPTED_CLOSED; M2-P7B_AUTHORITY_READY_FOR_REVIEW; M2-P7B_BEHAVIORAL_RED_LOCKED; M2-P7B_IMPLEMENTATION_LOCKED` | Independent review **ACCEPTED/CLOSED** P7A correction source/tooling `6c3a52bde905ee5e71e12334da1873ed20f5c5db`, GREEN `run-m2-p7a-green-20260916224033`, pre-closure HEAD `5bf8bf81d5628590dd41bb8989cefb72a2523175`. Oracle SHA-256 `63151da21b07c3dd92c5b4a7acc0d4f952f188ee2425a52c9d3ac8d34eb61035`; accepted RED, rejected GREEN cũ và P1–P6 evidence bất biến. P7B chỉ có authority/design draft chờ independent review, chưa được mở RED/code; open STOP gate: `BIGSERIAL` không bảo đảm commit-order/no-loss dưới concurrent writers, không được tự sửa P3 hoặc tạo `0008`. P8/P9 khóa; M3/Phân hệ A `NOT AUTHORIZED`. |
