...
| M2 | 🟡 `M2-P1..P7A_ACCEPTED_CLOSED; M2-P7B_AUTHORITY_ACCEPTED; M2-P7B_BEHAVIORAL_RED_READY_FOR_REVIEW; M2-P7B_IMPLEMENTATION_LOCKED` | P7A accepted source/tooling `6c3a52bde905ee5e71e12334da1873ed20f5c5db`, GREEN `run-m2-p7a-green-20260916224033`, oracle SHA-256 `63151da21b07c3dd92c5b4a7acc0d4f952f188ee2425a52c9d3ac8d34eb61035`; accepted/historical evidence bất biến. P7B RED source/test/seam `7fa928b1f715a66b0d5a579c2530884598ed482d`, evidence `run-m2-p7b-red-20260917000606`: exact 5 collected/5 failed đúng seam, #000 tái hiện race 3 lần; regressions bắt buộc PASS. Chờ independent review RED. Future fence phải nằm trong **một SQL statement** tương thích autocommit và P1 UoW; H01–H38 count=38 và P3 11/11 là GREEN hard gate. Implementation chưa được cấp quyền; không sửa P3 hoặc tạo `0008`. P8/P9 khóa; M3/Phân hệ A `NOT AUTHORIZED`. |
