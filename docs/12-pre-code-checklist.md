...
| M2 | 🟡 `M2-P2_RED_HARNESS_READY_BLOCKED_EXTERNAL` | Correction harness đã encode 11 behavioral oracle và collection exact 11 đạt; `M2_TEST_PG_DSN` chưa có nên PostgreSQL/CREATEDB/orphan prerequisite không thể xác minh. Không có Behavioral RED hợp lệ; implementation vẫn khóa. |
