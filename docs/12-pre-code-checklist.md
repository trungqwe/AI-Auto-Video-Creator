...
| M2 | 🟡 `M2-P1..P7A_ACCEPTED_CLOSED; M2-P7B_AUTHORITY_ACCEPTED; M2-P7B_BEHAVIORAL_RED_ACCEPTED; M2-P7B_IMPLEMENTATION_AUTHORIZED; M2-P7B_INDEX_AUTHORITY_DELTA_ACCEPTED; M2-P7B_P7A_TRACKER_COMPAT_DELTA_ACCEPTED` | P7A accepted Behavioral oracle SHA-256 `63151da21b07c3dd92c5b4a7acc0d4f952f188ee2425a52c9d3ac8d34eb61035` và P7B RED oracle SHA-256 `d83d0f2d808f1b0067d5288ea131ded24d8fc46a16462b5254fd4167f7425738` bất biến; P7B RED evidence `run-m2-p7b-red-20260917002633` accepted, run RED cũ giữ lịch sử. Review checkpoint `aed557f5269f0af7641197d9b662b2dcff5e8d65` cho phép đúng index/migration `0008`. Review checkpoint `1cbdcf1d2fc245d3d1515c8864fc6a3d8e377bc9` cho phép chỉ thân P7A hardening `test_h16_migration_tracker` chuyển sang latest-migration targeted rollback/reapply không hard-code version; không đổi H15/fixtures/identity/P7A production/Behavioral oracle. Phải chạy P7A hardening 36/36 trên full schema gồm 0008 trước khi tiếp tục source pin. P7B chưa final GREEN/accepted/closed; P8/P9 khóa; M3/Phân hệ A `NOT AUTHORIZED`. |
