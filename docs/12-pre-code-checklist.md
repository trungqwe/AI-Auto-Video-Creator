...
| M2 | 🟡 `M2-P1..P7A_ACCEPTED_CLOSED; M2-P7B_AUTHORITY_ACCEPTED; M2-P7B_BEHAVIORAL_RED_ACCEPTED; M2-P7B_IMPLEMENTATION_AUTHORIZED` | P7A accepted oracle SHA-256 `63151da21b07c3dd92c5b4a7acc0d4f952f188ee2425a52c9d3ac8d34eb61035` bất biến. Independent review chấp nhận P7B RED source/test `c35571fb334dc7b842ee23378f041e74f1caa277`, oracle SHA-256 `d83d0f2d808f1b0067d5288ea131ded24d8fc46a16462b5254fd4167f7425738` và evidence `run-m2-p7b-red-20260917002633`; run `run-m2-p7b-red-20260917000606` là lịch sử bị từ chối, giữ immutable. Quyền implementation chỉ mở P7B; one-statement fence trong đúng P3 `append()` và H01–H38 là hard gates. P7B chưa GREEN/accepted/closed; không tạo `0008` nếu chưa có authority delta. P8/P9 khóa; M3/Phân hệ A `NOT AUTHORIZED`. |
