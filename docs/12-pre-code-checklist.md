...
| M2 | 🟡 `M2-P1..P5B_ACCEPTED_CLOSED; M2-P6_BEHAVIORAL_RED_READY_FOR_REVIEW` | Exact four P6 oracle đã RED hợp lệ trên PostgreSQL 18.6 tại `run-m2-p6-20260916163000`; implementation P6 vẫn khóa chờ independent review. P7+, M3 và Phân hệ A chưa được phép. |
