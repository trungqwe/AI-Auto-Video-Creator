...
| M2 | 🟡 `M2-P1..P7A_ACCEPTED_CLOSED; M2-P7B_AUTHORITY_ACCEPTED; M2-P7B_BEHAVIORAL_RED_READY_FOR_REVIEW; M2-P7B_IMPLEMENTATION_LOCKED` | P7A accepted oracle SHA-256 `63151da21b07c3dd92c5b4a7acc0d4f952f188ee2425a52c9d3ac8d34eb61035` bất biến. P7B RED cũ `run-m2-p7b-red-20260917000606` bị independent review từ chối do #001 trái first-subscribe baseline; giữ immutable. Corrected source/test `c35571fb334dc7b842ee23378f041e74f1caa277` và fresh evidence `run-m2-p7b-red-20260917002633`: exact 5 collected/5 failed đúng seam, #000 tái hiện race 3 lần; P7A 4/4 + 36/36, P3 11/11, architecture 6/6, P6→P0 PASS; M1 `NOT_RUN`. Chờ independent review corrected RED. Future fence phải trong **một SQL statement** tương thích autocommit/P1 UoW; H01–H38 và P3 11/11 là GREEN hard gate. Implementation chưa được cấp quyền; không sửa P3 hoặc tạo `0008`. P8/P9 khóa; M3/Phân hệ A `NOT AUTHORIZED`. |
