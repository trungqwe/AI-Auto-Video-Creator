...
| M2 | 🟡 `M2-P4_RED_READY_FOR_REVIEW` | P1..P3 `ACCEPTED / CLOSED`; P4 exact 9 Behavioral RED đã được chứng kiến, nhưng implementation P4 chưa được ủy quyền và chờ independent audit. P5..P7 vẫn khóa. |
