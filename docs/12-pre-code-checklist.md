...
| M2 | 🟡 `M2-P3_PLAN_READY_FOR_REVIEW` | M2-P2 đã `ACCEPTED / CLOSED`. P3 chỉ được contract/plan hardening và chuẩn bị Behavioral RED; chưa có quyền tạo RED harness, implementation hay migration `0003`. |
