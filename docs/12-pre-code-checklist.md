...
| M2 | 🟡 `M2-P2_BEHAVIORAL_RED_BLOCKED_EXTERNAL` | P2 plan đã ACCEPTED; collection exact 11 đạt nhưng `M2_TEST_PG_DSN` chưa có nên PostgreSQL/CREATEDB/orphan prerequisite không thể xác minh. Không có Behavioral RED hợp lệ; implementation vẫn khóa. |
