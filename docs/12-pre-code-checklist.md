...
| M2 | 🟡 `M2-P1..P5B_ACCEPTED_CLOSED; M2-P6_BEHAVIORAL_RED_READY_FOR_REVIEW` | Corrected exact-four P6 oracle đã RED hợp lệ trên PostgreSQL 18.6 tại `run-m2-p6-20260916174500`; race winner, idempotent ledger và parent prerequisites đã được khóa đúng contract. Implementation P6 vẫn khóa chờ independent review. |
