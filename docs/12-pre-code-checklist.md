...
| M2 | 🟡 `M2-P1..P5A_ACCEPTED_CLOSED; M2-P5B_IMPLEMENTATION_READY_FOR_REVIEW` | P5B implementation candidate pin source `1d36920`; exact five GREEN và frozen regressions đạt. Chưa ACCEPT/CLOSE; P6+ vẫn khóa tới independent audit/user checkpoint. |
